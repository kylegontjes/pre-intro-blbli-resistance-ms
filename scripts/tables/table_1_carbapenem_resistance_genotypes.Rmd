...
table_1$Variable <- recode_genotypes(table_1$Variable)
...
nn_data$Variable <-  recode_genotypes(nn_data$variable)
...
diagnostic_stats$Variable <-  recode_genotypes(diagnostic_stats$Variable)
...
1. Note: final table is formatted in MW to add row headers, etc
```{r} 
colnames(table_1) <- recode(colnames(table_1),
                            'Variable' = "Mechanism of interest") 
