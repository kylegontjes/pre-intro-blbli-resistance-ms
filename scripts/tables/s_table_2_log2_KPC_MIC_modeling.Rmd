...
#Packages
packages <- c("tidyverse","gridExtra",'kableExtra',"tableone","ape","ggtree",'sjPlot','sjtable2df')
...
tab_model(MVB_simple,MVB_adjusted,MVB_interaction,IR_simple,IR_adjusted,IR_interaction,show.se = T,show.aic = T,show.df = T,file = "~/Desktop/gl_mount/Analysis/Combination_resistance/pre-intro-blbli-resistance-ms/tables/s_table_2.html")  
```