...
tab_model(MVB_simple,MVB_adjusted,MVB_interaction,IR_simple,IR_adjusted,IR_interaction,show.se = T,show.aic = T,show.df = F,file = "~/Desktop/gl_mount/Analysis/Combination_resistance/pre-intro-blbli-resistance-ms/tables/s_table_2.html")  
```