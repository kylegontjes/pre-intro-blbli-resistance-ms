---
title: "Supplemental Table 2: Log2 blaKPC regression modeling"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# Regression results
regression_results <- list(IR_simple=IR_simple,IR_adjusted=IR_adjusted,IR_interaction=IR_interaction,
                           MVB_simple=MVB_simple,MVB_adjusted=MVB_adjusted,MVB_interaction=MVB_interaction)
```

# Save html form of this table!
...
# Create table model
table_reg <- tab_model(IR_simple,IR_adjusted,IR_interaction,MVB_simple,MVB_adjusted,MVB_interaction,show.se = T,show.aic = T,file = NULL)  
...
# Create html version of results
