...
```{r}
convert_tableone_into_df(df,vars=c('OmpK36_c25t',"OmpK36_L3_mutations"),strata='clade_I',factorVars = c('OmpK36_c25t',"OmpK36_L3_mutations"),outcome_names = c("Clade I","Clade II"))
```
