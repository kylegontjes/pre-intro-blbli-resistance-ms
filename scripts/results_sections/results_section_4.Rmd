...
convert_tableone_into_df(dataset = AA018, vars = c('size','gc','rep_types','relaxase_types','mpf_type','orit_type','predicted_mobility','predicted_host_range_overall_rank',"observed_host_range_ncbi_name"))
...
convert_tableone_into_df(dataset = AA552, vars = c('size','gc','rep_types','relaxase_types','mpf_type','orit_type','predicted_mobility','predicted_host_range_overall_rank',"observed_host_range_ncbi_name"),strata = 'FJ223607',outcome_names = c("Not F","FJ"))
```
