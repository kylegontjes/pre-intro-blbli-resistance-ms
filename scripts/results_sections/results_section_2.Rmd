---
title: "Results Section 2: Differences in resistance emergence and spread exist across clades of epidemic-lineage ST258"
author: "Kyle Gontjes"
...
c(20,15,106,248) %>% matrix(ncol=2,dimnames = list(c("Clade I","Clade II"),c("Events","Susceptible")))
c(20,15,106,248) %>% matrix(ncol=2) %>% fisher.test()
paste0("Clustering, no significant difference but still interesting")
c(5,2,15,14) %>% matrix(ncol=2,dimnames = list(c("Clade I","Clade II"),c("Clusters","Singleton events")))
