...
#Packages
packages <- c("tidyverse","gridExtra",'kableExtra',"tableone","ape","ggtree",'sjPlot')
...
lm(MVB_log_2 ~ KPC_log_2 ,data=df_w_KPC) %>% tab_model() 
lm(MVB_log_2 ~ KPC_log_2 + OmpK36_mutations_simple,data=df_w_KPC) %>% tab_model()  
lm(MVB_log_2 ~ KPC_log_2 * OmpK36_mutations_simple,data=df_w_KPC) %>% tab_model() 

paste0("IR w/ KPC")
lm(IR_log_2 ~ KPC_log_2 ,data=df_w_KPC) %>%  tab_model() 
lm(IR_log_2 ~ KPC_log_2 + OmpK36_mutations_simple,data=df_w_KPC)  %>% tab_model()
lm(IR_log_2 ~ KPC_log_2 * OmpK36_mutations_simple,data=df_w_KPC) %>% tab_model()   
```
...
# Clade I
paste0("KPC w/ MVB or IR")
lm(MVB_log_2 ~ KPC_log_2 ,data=df_w_KPC_CI) %>% tab_model()  
lm(MVB_log_2 ~ KPC_log_2 + OmpK36_mutations_simple,data=df_w_KPC_CI) %>% tab_model()   
lm(MVB_log_2 ~ KPC_log_2 * OmpK36_mutations_simple,data=df_w_KPC_CI) %>% tab_model()  

paste0("IR w/ KPC")
lm(IR_log_2 ~ KPC_log_2 ,data=df_w_KPC_CI) %>% tab_model()  
lm(IR_log_2 ~ KPC_log_2 + OmpK36_mutations_simple,data=df_w_KPC_CI) %>% tab_model()   
lm(IR_log_2 ~ KPC_log_2 * OmpK36_mutations_simple,data=df_w_KPC_CI) %>% tab_model()   

# Clade II
paste0("KPC w/ MVB or IR")
lm(MVB_log_2 ~ KPC_log_2 ,data=df_w_KPC_CII) %>% tab_model()  
lm(MVB_log_2 ~ KPC_log_2 + OmpK36_mutations_simple,data=df_w_KPC_CII) %>% tab_model()   
lm(MVB_log_2 ~ KPC_log_2 * OmpK36_mutations_simple,data=df_w_KPC_CII) %>% tab_model()  


paste0("IR w/ KPC")
lm(IR_log_2 ~ KPC_log_2 ,data=df_w_KPC_CII) %>% tab_model()  
lm(IR_log_2 ~ KPC_log_2 + OmpK36_mutations_simple,data=df_w_KPC_CII) %>% tab_model()   
lm(IR_log_2 ~ KPC_log_2 * OmpK36_mutations_simple,data=df_w_KPC_CII) %>% tab_model()   
```
