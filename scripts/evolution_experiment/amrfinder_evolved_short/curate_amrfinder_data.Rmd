...
# Load amrfinder
```{r}
amrfinder<- read_delim("./data/evolution_experiment/amrfinder_evolved_short/evolved_amrfinder_results_short.txt") 
...
saveRDS(amrfinder,file="./data/evolution_experiment/amrfinder_evolved_short/amrfinder_curated_short.RDS")
``` 