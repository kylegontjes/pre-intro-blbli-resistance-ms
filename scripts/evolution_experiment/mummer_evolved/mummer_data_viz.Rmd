...
setwd("./data/evolution_experiment/mummer_evolved/")
tn4401_hopping <- make_plots(filename = 'PCMP_H19_PCMP_H019_MVB_R.coords',contig_data = contig_data,blast_data = KPC_blast) 
tn4401_hopping
#ggsave("../../figures/s_figure_6.png", plot=tn4401_hopping, width = 14, height = 10.5, dpi=900)
```
...
setwd("./data/evolution_experiment/mummer_evolved/")
tn4401_hopping <- make_plots(filename = 'PCMP_H226_PCMP_H226_MVB_R.coords',contig_data = contig_data,blast_data = KPC_blast) 
tn4401_hopping
#ggsave("../../figures/s_figure_6.png", plot=tn4401_hopping, width = 14, height = 10.5, dpi=900)
```
...
```{r,fig.width=14,fig.height=10.5}
setwd("./data/evolution_experiment/mummer_evolved/")
tn4401_hopping <- make_plots(filename = 'PCMP_H323_PCMP_H323_MVB_R.coords',contig_data = contig_data,blast_data = KPC_blast) 
tn4401_hopping
#ggsave("../../figures/s_figure_6.png", plot=tn4401_hopping, width = 14, height = 10.5, dpi=900)
```
...
setwd("./data/evolution_experiment/mummer_evolved/")
tn4401_hopping <- make_plots(filename = 'PCMP_H414_PCMP_H414_MVB_R.coords',contig_data = contig_data,blast_data = KPC_blast) 
tn4401_hopping
#ggsave("../../figures/s_figure_6.png", plot=tn4401_hopping, width = 14, height = 10.5, dpi=900)
```
...
```{r,fig.width=18,fig.height=18}
setwd("./data/evolution_experiment/mummer_evolved/")
tn4401_hopping <- make_plots(filename = 'PCMP_H464_PCMP_H464_MVB_R.coords',contig_data = contig_data,blast_data = KPC_blast) 
tn4401_hopping
#ggsave("../../figures/s_figure_6.png", plot=tn4401_hopping, width = 14, height = 10.5, dpi=900)
```