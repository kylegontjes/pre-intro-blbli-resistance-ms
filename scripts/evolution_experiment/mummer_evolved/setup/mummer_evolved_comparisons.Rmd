---
title: "Evolution experiment mummer setup script"
...
opts_knit$set(root.dir='~/Desktop/gl_mount/Analysis/Combination_resistance/pre-intro-blbli-resistance-ms/scripts/evolution_experiment/mummer_evolved/')
```
...
#SBATCH --output=/nfs/turbo/umms-esnitkin/Project_Penn_KPC/Analysis/Combination_resistance/pre-intro-blbli-resistance-ms/slurm_out/evolution_experiment/mummer_evolution/prefix.out
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=1 --mem=3g --time=00:15:00

echo 'Running nucmer' 

# Move to relevant directory
cd /nfs/turbo/umms-esnitkin/Project_Penn_KPC/Analysis/Combination_resistance/pre-intro-blbli-resistance-ms/data/evolution_experiment/mummer_evolved/
...
```{r}
library(tidyverse) 
comparisons <- read.delim("./comparisons/mummer_evolved_comparisons.txt",sep = "")
