...
```{r ,fig.height=12,fig.width=21.5}
s_figure_5 <- plot_grid(s_figure_5A,s_figure_5BC,rel_heights = c(1,1),rel_widths = c(1,.35))  
s_figure_5
```
 
```{r,message=F,echo=F,error=F,warning=F,fig.width=21.5,fig.height=15} 
ggsave(plot = s_figure_5, filename = './figures/s_figure_5.png', width = 21.5, height = 12,limitsize=FALSE, bg='white',dpi=900)
```