...
# Imipenem-relebactam
fig4e <- KPC_copy_number_ompk_hist_facet(df_w_KPC, y="IR_log_2", x="KPNIH1_RS28775_chr_median_norm", color = "OmpK36_mutations_simple_strata", title="", colors = ompK36_colors) + ylab("Log<sub>2</sub> IR MIC") + xlab("Log<sub>2</sub> <i> bla</i><sub>KPC</sub> copy number") + figure_4_format + ompK36_color_scale  

# Meropenem-vaborbactam
fig4f <- KPC_copy_number_ompk_hist_facet(df_w_KPC, y="MVB_log_2", x="KPNIH1_RS28775_chr_median_norm", color = "OmpK36_mutations_simple_strata", title="", colors = ompK36_colors) + ylab("Log<sub>2</sub> MVB MIC") + xlab("Log<sub>2</sub> <i> bla</i><sub>KPC</sub> copy number") + figure_4_format + ompK36_color_scale  
```
...
fig4.data.all <- cowplot::plot_grid(fig4.data, fig4.data.2, ncol=1, rel_heights = c(1,.7))
