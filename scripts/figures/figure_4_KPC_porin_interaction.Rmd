...
fig4.data <- cowplot::plot_grid(fig4a + theme(legend.position = "none"), fig4b + theme(legend.position = "none"), fig4c + theme(legend.position = "none"),fig4d + theme(legend.position = "none"), ncol=2, rel_widths = c(1,.7,1,.7), labels = "AUTO", label_size = 18)

fig4.data.2 <- cowplot::plot_grid(fig4e + theme(legend.position = "none"), fig4f+ theme(legend.position = "none"), ncol=2, labels = c("E","F"), label_size=18)
