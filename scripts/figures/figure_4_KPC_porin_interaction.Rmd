...
# KPC Data 
fig4e <- KPC_copy_number_ompk_hist(df,y="IR_log_2",x="KPNIH1_RS28775_chr_median_norm",color = "OmpK36_mutations_simple",title="",colors = ompK36_colors) + ylab("Log<sub>2</sub> IR MIC") + xlab("Log<sub>2</sub> <i> bla<sub>KPC</sub></i> copy number")   + figure_4_format + ompK36_color_scale

fig4f <- KPC_copy_number_ompk_hist(df,y="MVB_log_2",x="KPNIH1_RS28775_chr_median_norm",color = "OmpK36_mutations_simple",title="",colors = ompK36_colors) + ylab("Log<sub>2</sub> MVB MIC") + xlab("Log<sub>2</sub> <i> bla<sub>KPC</sub></i> copy number")   + figure_4_format + ompK36_color_scale
