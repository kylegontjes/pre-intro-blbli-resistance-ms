...
fig4b <- MIC_ompk36_prop_hist(IR_ompk36_prop,"") + theme_bw_me   + ompK36_scale + xlab("Resistance category")+ ylab("Proportion (%)") +figure_4_format + ompK36_scale
fig4d <- MIC_ompk36_prop_hist(MVB_ompk36_prop,"") + theme_bw_me  + ompK36_scale + xlab("Resistance category") + ylab("Proportion (%)") +figure_4_format + ompK36_scale

# KPC Data 
fig4e <- KPC_copy_number_ompk_hist(df,y="IR_log_2",x="KPNIH1_RS28775_chr_median_norm",color = "OmpK36_mutations_simple",title="",colors = ompK36_colors) + ylab("Log-2 IR MIC") + xlab("Log-2 KPC copy number")   + figure_4_format + ompK36_color_scale

fig4f <- KPC_copy_number_ompk_hist(df,y="MVB_log_2",x="KPNIH1_RS28775_chr_median_norm",color = "OmpK36_mutations_simple",title="",colors = ompK36_colors) + ylab("Log-2 MVB MIC") + xlab("Log-2 KPC copy number")   + figure_4_format + ompK36_color_scale
