---
title: "Supplemental Figure 11: Differential potential for emergence and spread of β-lactam/β-lactamase inhibitor resistance-associated genotypes "
...
s_figure_11.A <- ggdraw() + draw_image(tmpfile)
unlink(tmpfile)
s_figure_11 <- cowplot::plot_grid(s_figure_11.A,B_w_tree, labels = "AUTO", ncol=2, label_size = 20,rel_widths = c(1,0.65))
s_figure_11
``` 

```{r,message=F,echo=F,error=F,warning=F,fig.width=11,fig.height=6.5} 
ggsave(plot = s_figure_11, filename = './figures/s_figure_11_genotype_clustering.png', width = 11, height = 6.5, limitsize=FALSE, bg='white', dpi=900)
```