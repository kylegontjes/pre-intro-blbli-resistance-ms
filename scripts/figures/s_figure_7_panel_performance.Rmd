...
s_figure_7 <- cowplot::plot_grid(A + theme(legend.position = "none"),B+ theme(legend.position = "none"),C+ theme(legend.position = "none"),D+ theme(legend.position = "none"),E+ theme(legend.position = "none"),fig_legend,labels = c("A","B","C","D","E",""),ncol=2,label_size = 18,rel_widths = c(1,1,1,1,1,1),label_y = 1,label_x = -0.009)
 
s_figure_7
```

```{r}
ggsave(plot = s_figure_7, filename = './figures/s_figure_7.png', width = 12, height = 10.5,limitsize=FALSE,bg='white',dpi=900)
```