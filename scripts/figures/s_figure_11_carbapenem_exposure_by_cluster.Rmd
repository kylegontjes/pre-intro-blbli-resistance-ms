...
wo_legend <- cowplot::plot_grid(FA + theme(legend.position="none"),FB+ theme(legend.position="none"),FC+ theme(legend.position="none"),FD+ theme(legend.position="none"),FE+ theme(legend.position="none"),FF+ theme(legend.position="none"),FG+ theme(legend.position="none"),FH+ theme(legend.position="none"),ncol=4,labels ="AUTO", label_size = 18,rel_widths = c(1,1.25,1.25,1.4,1,1.25,1.25,1.4))
...
ggsave(plot = s_figure_11, filename = './figures/s_figure_11.png', width = 15, height = 7.5,limitsize=FALSE,bg='white')
```