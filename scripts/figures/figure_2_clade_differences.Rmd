...
# Imipenem-relebactam
fig2a <- create_MIC_histogram(df$IR_log_2,df$clade_I,"Imipenem-relebactam") + ylim(NA,250)   +figure_2_format + clade_colors_scale_3_col   +MIC_IR_x_scale + IR_intercepts[[1]] + IR_intercepts[[2]]

# Meropenem-vaborbactam
fig2c <- create_MIC_histogram(df$MVB_log_2,df$clade_I,"Meropenem-vaborbactam") + ylim(NA,250)   +figure_2_format + clade_colors_scale_3_col   +MIC_MVB_x_scale + MVB_intercepts[[1]] + MVB_intercepts[[2]]
```
...
# Figure
```{r,message=F,echo=F,error=F,warning=F,fig.width=9.5,fig.height=7.14}
figure_2
```

## Save figure
```{r}
ggsave(plot = figure_2, filename = './figures/figure_2.png', width = 9.5, height = 7.14,bg = 'white', dpi=900)
```