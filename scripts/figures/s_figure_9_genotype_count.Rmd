...
s_figure_9_main <- variant_freq_histogram(all_variants_annots,bins=100)   + s_figure_9_format
...
s_figure_9 <- s_figure_9_main +  annotation_custom(ggplotGrob(s_figure_9_inlet), xmin = 40, xmax = 100, ymin = 500, ymax = 4000)
s_figure_9 
```

```{r,message=F,echo=F,error=F,warning=F,fig.width=5.5,fig.height=4.5} 
ggsave(plot = s_figure_9, filename = './figures/s_figure_9.png', width = 5, height = 4,limitsize=FALSE,bg='white',dpi=900)
```
