...
```{r,fig.height=9.5,fig.width=7.6}
...
```{r}
ggsave(plot = s_figure_10, filename = './figures/s_figure_10_panel_performance.png', height = 9.5, width = 7.6, limitsize=FALSE, bg='white', dpi=900)
```