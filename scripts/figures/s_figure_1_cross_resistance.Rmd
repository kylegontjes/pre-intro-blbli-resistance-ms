...
# Print & Save
```{r,message=F,error=F,warning=F,fig.width=9.25,fig.height=4.625}
s_figure_1
```

```{r}
ggsave(plot = s_figure_1, filename = './figures/s_figure_1.png', width = 9.25, height = 4.625, bg = "white",dpi=900)
```