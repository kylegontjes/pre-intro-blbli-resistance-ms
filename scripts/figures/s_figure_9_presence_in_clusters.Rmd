...
s_figure_9.A <- ggdraw() + draw_image(tmpfile)
unlink(tmpfile)
s_figure_9 <- cowplot::plot_grid(s_figure_9.A,B_w_tree,labels = "AUTO",ncol=2,label_size = 20,rel_widths = c(1,0.625))
s_figure_9
``` 

```{r,message=F,echo=F,error=F,warning=F,fig.width=20,fig.height=12.5} 
ggsave(plot = s_figure_9, filename = './figures/s_figure_9.png', width = 11.375, height = 6.5,limitsize=FALSE,bg='white',dpi=900)
```