...
```{r ,fig.height=55,fig.width=87.5}
s_figure_4.FA <- plot_grid(s_figure_4.A,labels = "A.",label_size=62,align = "hv") + theme(plot.margin = unit(c(-40,0,0,0), "cm")) 
...
ggsave(plot = s_figure_4, filename = './figures/s_figure_4.png', width = 87.5, height = 50,limitsize=FALSE)
```
