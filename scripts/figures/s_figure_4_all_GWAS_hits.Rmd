...
s_figure_4.FCD <- plot_grid(s_figure_4.C,s_figure_4.D ,nrow = 2,labels = c("C","D"),label_size = 24,align = "hv",label_x = -0.02)
s_figure_4.FCDB <- plot_grid(s_figure_4.FB,s_figure_4.FCD,ncol = 2,rel_heights = c(1,1),rel_widths = c(1,0.675)) 
```

```{r ,fig.height=17.25,fig.width=26}
s_figure_4.FA <- plot_grid(s_figure_4.A,labels = "A",label_size=24,align = "hv")  
s_figure_4 <- plot_grid(s_figure_4.FA,s_figure_4.FCDB,labels = c("",""),nrow=2,label_size = 24, rel_heights = c(0.325,1))   
s_figure_4
```
