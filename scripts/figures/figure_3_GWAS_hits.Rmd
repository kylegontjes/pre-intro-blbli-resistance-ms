...
figure_3.FCD <- plot_grid(figure_3.C,figure_3.D ,nrow = 2,labels = c("C","D"),label_size = 24,align = "hv",label_x = -0.02)
figure_3.FCDB <- plot_grid(figure_3.FB,figure_3.FCD,ncol = 2,rel_heights = c(1,1),rel_widths = c(1,0.65)) 
```

```{r ,fig.height=17.5,fig.width=26}
figure_3.FA <- plot_grid(figure_3.A,labels = "A",label_size=24,align = "hv")  
figure_3 <- plot_grid(figure_3.FA,figure_3.FCDB,labels = c("",""),nrow=2,label_size = 24, rel_heights = c(0.25,1))   
figure_3
```

```{r,message=F,echo=F,error=F,warning=F,fig.width=20,fig.height=12.5} 
ggsave(plot = figure_3, filename = './figures/figure_3.png', width = 85.5, height = 50,limitsize=FALSE)
```
