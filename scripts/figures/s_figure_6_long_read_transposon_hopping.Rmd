...
```{r}
kpc_contigs <- blast_lr %>% subset(element_symbol  %in% c('KPC',"KPC-2","KPC-3","KPC-5"))%>% select(isolate_no,contig,element_symbol) %>% distinct
...
ggsave("../../figures/s_figure_6.png",plot=tn4401_hopping,width = 17,height = 13)
```
