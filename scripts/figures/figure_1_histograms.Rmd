...
MIC_histograms <- plot_grid(figure1A + theme(legend.position = "none"),figure1B + theme(legend.position = "none"), ncol = 2, labels = "AUTO", label_size = 20)
figure1 <- plot_grid(MIC_histograms,MIC_legend_plot, ncol=1,rel_heights = c(1,0.135)) 
``` 

## Figure
```{r,message=F,error=F,warning=F,fig.width=9.5,fig.height=5.5}
figure1
```

```{r}
ggsave(plot = figure1, filename = './figures/figure_1.png', width = 9.5, height = 5.5, bg = "white")
```
