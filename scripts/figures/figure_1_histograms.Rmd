...
figure1 <- plot_grid(MIC_histograms,MIC_legend_plot, ncol=1,rel_heights = c(1,0.145)) 
``` 

## Figure
```{r,message=F,error=F,warning=F,fig.width=9.5,fig.height=5}
figure1
```

```{r}
ggsave(plot = figure1, filename = './figures/figure_1.png', width = 9.5, height = 5, bg = "white",dpi=900)
```
