...
s_figure_3_B <- freq_plot(gwas_nons_freq) 
```
...
s_figure_3_C <- nn_plot(nn_data_melt)  
```

```{r ,fig.height=50,fig.width=110}
s_figure_3BC <- plot_grid(s_figure_3_B,s_figure_3_C ,nrow = 2,labels = c("B","C"),label_size = 62,align = "hv",label_x = -0.02)  + theme(plot.margin = unit(c(t=0,r=0,b=0,l=0.1), "cm")) 
s_figure_3 <- plot_grid(s_figure_3_A,s_figure_3BC,labels = c("A",""),label_size = 62,ncol = 2,rel_heights = c(1,0.75),rel_widths = c(1,0.55)) + theme(plot.margin = unit(c(0,0,0,0), "cm")) 

s_figure_3
```

```{r,message=F,echo=F,error=F,warning=F,fig.width=20,fig.height=12.5} 
ggsave(plot = s_figure_3, filename = './figures/s_figure_3.png', width = 110, height = 50,limitsize=FALSE)
```
