---
title: "Supplemental Figure 13: Proportion of isolates with a core genome variant"
...
s_figure_12_main <- variant_freq_histogram(all_variants_annots,bins=100)   + s_figure_12_format + ylim(NA,4050)
...
s_figure_12 <- s_figure_12_main +  annotation_custom(ggplotGrob(s_figure_12_inlet), xmin = 40, xmax = 100, ymin = 500, ymax = 4250)
s_figure_12 
```

```{r,message=F,echo=F,error=F,warning=F,fig.width=4.5,fig.height=3.6} 
ggsave(plot = s_figure_12, filename = './figures/s_figure_13_genotype_count.png', width = 4.5, height = 3.6, limitsize=FALSE, bg='white', dpi=900)
```
