---
title: "Supplemental Figure 12: Proportion of isolates with a core genome variant"
...
ggsave(plot = s_figure_12, filename = './figures/s_figure_12_genotype_count.png', width = 4.5, height = 3.6, limitsize=FALSE, bg='white', dpi=900)
```
