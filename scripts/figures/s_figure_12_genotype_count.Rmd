...
s_figure_12_main <- variant_freq_histogram(all_variants_annots,bins=150)   + s_figure_12_format
...
s_figure_12 <- s_figure_12_main +  annotation_custom(ggplotGrob(s_figure_12_inlet), xmin = 0.5, xmax = 1, ymin = 1250, ymax = 3250)
s_figure_12 
```
