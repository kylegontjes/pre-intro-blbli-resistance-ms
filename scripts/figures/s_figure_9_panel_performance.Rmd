...
s_figure_9 <- cowplot::plot_grid(plots,fig_legend,ncol=1,rel_heights=c(1,0.16))
s_figure_9
```

```{r}
ggsave(plot = s_figure_9, filename = './figures/s_figure_9.png', width = 12, height = 8,limitsize=FALSE)
```