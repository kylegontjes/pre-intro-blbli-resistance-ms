...
panels <- c("known","novel_synchronous","known_ST258_GWAS")
...
BLBLI_panel$panels <- factor(BLBLI_panel$panels,levels = c("known","novel_synchronous","AA552","known_ST258_GWAS","known_ST258_GWAS_AA552"))
...
plots <- cowplot::plot_grid(A + theme(legend.position = "none"),B+ theme(legend.position = "none"),C+ theme(legend.position = "none"),D+ theme(legend.position = "none"),labels = c("A","B","C","D"),ncol=2,label_size = 16,rel_widths = c(1,1,1,1),label_y = 1,label_x = -0.009)

fig_legend <- get_legend(A )

s_figure_9 <- cowplot::plot_grid(plots,fig_legend,ncol=1,rel_heights=c(1,0.05))
s_figure_9
```
