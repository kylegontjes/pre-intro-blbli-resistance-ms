...
# Figure
```{r,message=F,error=F,warning=F,fig.width=5.3125,fig.height=4.25}
s_figure_2
```

## Save
```{r}
ggsave(plot = s_figure_2, filename = './figures/s_figure_2.png', width = 5.3125, height = 4.25,bg='white', dpi=900)
```
