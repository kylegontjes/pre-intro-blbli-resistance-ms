---
title: "Supplemental Figure 14: Proportion of isolates with a core genome variant"
...
#Packages
packages <- c("tidyverse","cowplot","gridExtra","tableone")
...
s_figure_14_main <- variant_freq_histogram(all_variants_annots,bins=100)   + s_figure_14_format + ylim(NA,4050)

s_figure_14_inlet <- variant_freq_histogram(all_variants_annots %>% subset(genotype_freq<=0.05),bins=30) + theme(legend.position = "none") + xlab("") + ylab("")

s_figure_14 <- s_figure_14_main +  annotation_custom(ggplotGrob(s_figure_14_inlet), xmin = 40, xmax = 100, ymin = 500, ymax = 4250)
...
ggsave(plot = s_figure_14, filename = './figures/s_figure_14_genotype_count.png', width = 4.5, height = 3.6, limitsize=FALSE, bg='white', dpi=900)
```
