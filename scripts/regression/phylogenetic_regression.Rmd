...
```{r} 
purposeful_output <-  phyloaware_regression(trait = 'blbli_dich_num',variables =eligible_variables,df=df,first_present=T,patient_id="Patient_ID",culture_date="Cx_date",multivariable='purposeful',stepwise_direction = NULL,entry_criteria = 0.20,retention_criteria = 0.10,confounding_criteria = 1000e1000)
