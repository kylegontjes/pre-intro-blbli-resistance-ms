...
```{r}
descriptive_data <- descriptive_stats("blbli_dich_num",datasets = datasets,variables = eligible_variables,factor_vars = subset(eligible_variables,!eligible_variables %in% c("age","LOSbeforeCx")),outcome_names = c("Susceptible","Non-Susceptible"))
