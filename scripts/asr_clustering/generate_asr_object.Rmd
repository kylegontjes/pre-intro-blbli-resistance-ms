...
# Run phylosuite
```{r}  
asr_model <- phyloAMR::asr(df = df, tr = tr, tip_name_variable = "isolate_no", trait = 'blbli_dich_num', model = 'MF', node_states = "joint", upper_bound = 1e50, lower_bound = 1e-9, confidence_threshold =  NULL) 
